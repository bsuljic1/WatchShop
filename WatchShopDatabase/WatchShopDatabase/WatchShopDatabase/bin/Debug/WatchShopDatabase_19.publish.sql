...
GO
PRINT N'Dropping Foreign Key [dbo].[Fk_User_Cart_UserId]...';


GO
ALTER TABLE [dbo].[Cart] DROP CONSTRAINT [Fk_User_Cart_UserId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_User_Purchase_UserId]...';


GO
ALTER TABLE [dbo].[Purchase] DROP CONSTRAINT [Fk_User_Purchase_UserId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_User_UserRole_UserId]...';


GO
ALTER TABLE [dbo].[UserRole] DROP CONSTRAINT [Fk_User_UserRole_UserId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_User_WishList_UserId]...';


GO
ALTER TABLE [dbo].[WishList] DROP CONSTRAINT [Fk_User_WishList_UserId];
