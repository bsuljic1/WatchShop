...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Watch]...';


GO
ALTER TABLE [dbo].[Watch]
    ADD DEFAULT NEWID() FOR [WatchId];
...
DECLARE @ScriptId uniqueidentifier = '683D2891-6CC3-470B-8C47-65028D46B4E4';
DECLARE @execTime datetime = null;
...
BEGIN
	...
	(NEWID(), 'PRW-6600Y-1ER', '2019-10-20', 'plastic', 52, 10, 250, 5, 2, 'https://www.citytime.ba/media/slikeIT/rocna-ura-Casio-PRW-6600Y-1ER.jpg', (SELECT BrandId FROM dbo.Brand WHERE BrandName='Casio'), (SELECT GenderId FROM dbo.Gender WHERE GenderName='Man'), (SELECT ConditionId FROM dbo.Condition WHERE ConditionName='New'), (SELECT ColorId FROM dbo.Color WHERE ColorName='Black') )
END 
GO
