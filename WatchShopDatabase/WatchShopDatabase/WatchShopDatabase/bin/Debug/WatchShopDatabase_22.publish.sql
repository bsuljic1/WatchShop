...
GO
PRINT N'Dropping Default Constraint unnamed constraint on [dbo].[Watch]...';


GO
ALTER TABLE [dbo].[Watch] DROP CONSTRAINT [DF__Watch__WatchId__52593CB8];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Watch_Cart_WatchId]...';


GO
ALTER TABLE [dbo].[Cart] DROP CONSTRAINT [Fk_Watch_Cart_WatchId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Watch_Purchase_WatchId]...';


GO
ALTER TABLE [dbo].[Purchase] DROP CONSTRAINT [Fk_Watch_Purchase_WatchId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Watch_StyleWatch_WatchId]...';


GO
ALTER TABLE [dbo].[StyleWatch] DROP CONSTRAINT [Fk_Watch_StyleWatch_WatchId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Condition_Watch_ConditionId]...';


GO
ALTER TABLE [dbo].[Watch] DROP CONSTRAINT [Fk_Condition_Watch_ConditionId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Brand_Watch_BrandId]...';


GO
ALTER TABLE [dbo].[Watch] DROP CONSTRAINT [Fk_Brand_Watch_BrandId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Gender_Watch_GenderId]...';


GO
ALTER TABLE [dbo].[Watch] DROP CONSTRAINT [Fk_Gender_Watch_GenderId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Color_Watch_ColorId]...';


GO
ALTER TABLE [dbo].[Watch] DROP CONSTRAINT [Fk_Color_Watch_ColorId];


GO
PRINT N'Dropping Foreign Key [dbo].[Fk_Watch_WishList_WatchId]...';


GO
ALTER TABLE [dbo].[WishList] DROP CONSTRAINT [Fk_Watch_WishList_WatchId];


GO
PRINT N'Starting rebuilding table [dbo].[Watch]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Watch] (
    [WatchId]          UNIQUEIDENTIFIER DEFAULT NEWID() NOT NULL,
    ...
    CONSTRAINT [tmp_ms_xx_constraint_Pk_Watch_WatchId1] PRIMARY KEY CLUSTERED ([WatchId] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Watch])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Watch] ([WatchId], [Model], [DatePublished], [BraceletMaterial], [CaseDiameter], [WaterResistant], [Price], [ShippingPrice], [Guarantee], [ImagePath], [BrandId], [GenderId], [ConditionId], [ColorId], [Name])
        SELECT   [WatchId],
                 [Model],
                 [DatePublished],
                 [BraceletMaterial],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Watch]', N'Watch';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_Pk_Watch_WatchId1]', N'Pk_Watch_WatchId', N'OBJECT';
...
GO
ALTER TABLE [dbo].[StyleWatch] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Watch] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Cart] WITH CHECK CHECK CONSTRAINT [Fk_Watch_Cart_WatchId];

ALTER TABLE [dbo].[Purchase] WITH CHECK CHECK CONSTRAINT [Fk_Watch_Purchase_WatchId];

ALTER TABLE [dbo].[StyleWatch] WITH CHECK CHECK CONSTRAINT [Fk_Watch_StyleWatch_WatchId];

ALTER TABLE [dbo].[Watch] WITH CHECK CHECK CONSTRAINT [Fk_Condition_Watch_ConditionId];

ALTER TABLE [dbo].[Watch] WITH CHECK CHECK CONSTRAINT [Fk_Brand_Watch_BrandId];

ALTER TABLE [dbo].[Watch] WITH CHECK CHECK CONSTRAINT [Fk_Gender_Watch_GenderId];

ALTER TABLE [dbo].[Watch] WITH CHECK CHECK CONSTRAINT [Fk_Color_Watch_ColorId];

ALTER TABLE [dbo].[WishList] WITH CHECK CHECK CONSTRAINT [Fk_Watch_WishList_WatchId];
